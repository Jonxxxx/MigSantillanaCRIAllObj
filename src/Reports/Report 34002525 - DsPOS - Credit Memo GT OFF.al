report 34002525 "DsPOS - Credit Memo GT OFF"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DsPOS - Credit Memo GT OFF.rdlc';
    Caption = 'DsPOS - Credit Memo GT OFF';
    ...
    dataset
    {
        dataitem("Sales Header"; 36)
        {
            ...
            column(Sales_Invoice_Header_Document_Type; "Document Type")
            {
            }
            column(Sales_Invoice_Header_No; "No.")
            {
            }
            column(Sales_Header_Texto; wTextCab)
            {
            }
            column(Sales_Invoice_Posting_No; "Posting No.")
            {
            }
            column(Cupones1; wCupones[1])
            {
            }
            column(Cupones2; wCupones[2])
            {
            }
            column(Cupones3; wCupones[3])
            {
            }
            column(Cupones4; wCupones[4])
            {
            }
            column(Cupones5; wCupones[5])
            {
            }
            column(Cupones6; wCupones[6])
            {
            }
            column(Cupones7; wCupones[7])
            {
            }
            column(Cupones8; wCupones[8])
            {
            }
            column(Cupones9; wCupones[9])
            {
            }
            column(Cupones10; wCupones[10])
            {
            }
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    dataitem("Sales Line"; 37)
                    {
                        ...
                        begin
                            ...
                            IF "Sales Line"."Cod. Cupon" <> '' THEN BEGIN

                                BucleCupones := 1;
                                CuponEncontrado := FALSE;

                                WHILE ((BucleCupones <= ContCupones)) AND (NOT (CuponEncontrado)) DO BEGIN
                                    CuponEncontrado := ("Sales Line"."Cod. Cupon" = wCupones[BucleCupones]);
                                    BucleCupones += 1;
                                END;

                                IF NOT CuponEncontrado THEN BEGIN
                                    wCupones[ContCupones] := "Sales Line"."Cod. Cupon";
                                    ContCupones += 1;
                                END;
            ...
            begin
                ...
                IF "Sales Header".Devolucion THEN
                    wTextCab := TextDev
                ELSE
                    wTextCab := TextNC;
                ...
                END;
                //fes mig FormatAddr.SalesHeaderShipTo(ShipToAddr,"Sales Header");
    ...
    var
        ...
        TextNC: Label 'NOTA DE CREDITO';
        TextDev: Label 'NOTA DE CREDITO';
        ...
        wTextCab: Text;
        wCupones: array[10] of Code[20];
        ContCupones: Integer;
        BucleCupones: Integer;
        CuponEncontrado: Boolean;
