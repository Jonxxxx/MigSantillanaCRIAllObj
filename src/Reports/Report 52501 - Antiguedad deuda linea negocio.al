...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/ReportsLayout/Antiguedad deuda linea negocio.rdlc';
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Global Dimension 1 Filter", "No.", "Search Name", "Customer Posting Group", "Statistics Group", "Payment Terms Code";
            ...
            column(SaldoTotalCaption; TotalSaldo_Lbl)
            {
            }
            column(SaldoTotal; decSaldoTotal)
            {
            }
            column(ProvisionCaption; ProvisionLbl)
            {
            }
            ...
            begin
                ...
                DtldCustLedgEntry.SETCURRENTKEY("Customer No.", "Initial Entry Due Date", "Posting Date", "Initial Entry Global Dim. 1");
                ...
                decSaldoTotal := DtldCustLedgEntry."Amount (LCY)";
    ...
    var
        ...
        TotalSaldo_Lbl: Label 'Total saldo';
