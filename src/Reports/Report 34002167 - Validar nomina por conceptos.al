report 34002167 "Validar nomina por conceptos"
{
    ...
    dataset
    {
        dataitem("Historico Lin. nomina"; 34002118)
        {
            ...
            column("Historico_Lin__nomina_Total"; Total)
            {
            }
            ...
            column("Historico_Lin__nomina_Total_Control7"; ABS(Total))
            {
            }
            column("Historico_Lin__nomina_Cantidad_Control1000000000"; Cantidad)
            {
            }
            column("Historico_Lin__nomina_Total_Control10"; ABS(Total))
            {
            }
            ...
            column("Historico_Lin__nomina_TotalCaption"; FIELDCAPTION(Total))
            {
            }
