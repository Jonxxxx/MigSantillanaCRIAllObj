report 56138 "Estadisticas de Vtas."
{
    ...
    // 
    // #2297  CAT 03/04/2014  Añadido campo "Cod. categoria producto" y "Nº Devolucion" para filtro de los usuarios.
    ...
    // 
    // 010 #56268 RRT 01.09.2016: Correccion en la version para Excel, para la columna "Vta. Liquida"
    // 011 #56799 RRT 15.09.2016: Que se pueda invocar como SAVEASEXCEL. Añadir las columnas de codigo y descripcion del vendedor.
    ...
    // 013 #58537 RRT 19.10.2016: Mostrar la descripcion del producto en la version Excel.
    // 014 #62474 JMB 23.01.2011: Añadir la descripcion del cliente justo despues del codigo (en el layout RDLC).
    // 015 #188565 YFC 1/15/2019: Adicionar 3 campos a reporte de Estadisticas de Vtas. (EXCEL)
    ...
    dataset
    {
        dataitem("Value Entry"; 5802)
        {
            ...
            begin
                ...
                IF Cust.GET("Source No.") THEN BEGIN
                    IF Contact.GET(Cust."Cod. Colegio") THEN BEGIN
                        NombreColegio := Contact.Name;
                    ...
                    CASE "Document Type" OF
                        "Document Type"::"Sales Invoice":
                            IF lrSIH.GET("Document No.") THEN
                                IF lrSIH."Nombre Colegio" <> '' THEN BEGIN //017+-
                                ...
                                ELSE BEGIN
                                    IF lrSIH."Cod. Colegio" <> '' THEN BEGIN
                                        ...
                                        IF lrContact.GET(lrSIH."Cod. Colegio") THEN
                                            IF lrContact.Name <> '' THEN BEGIN //017+-
                        ...
                        "Document Type"::"Sales Credit Memo":
                            IF lrSCMH.GET("Document No.") THEN
                                IF lrSCMH."Nombre Colegio" <> '' THEN BEGIN //017+-
    ...
    var
        ...
        Dim1CaptionLbl: Label 'Linea de negocio :';
    ...
    begin
        ...
        ExcelBuf.AddColumn('Categoria Pedido', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text); //018+-
        ...
        IF Detallado THEN BEGIN  //+013
            ExcelBuf.AddColumn('Cod. Vendedor', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
        ...
        // ++ #188565
        //SANTINAV-2210
        ExcelBuf.AddColumn('Codigo Colegio ', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
        //SANTINAV-2210
        ...
        ExcelBuf.AddColumn('Dimension REGULAR/COMPARTIR', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
    ...
    begin
        ...
        ExcelBuf.NewRow;
        ExcelBuf.AddColumn('Linea de Negocio', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
