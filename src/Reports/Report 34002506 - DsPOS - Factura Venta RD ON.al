report 55900 "DsPOS - Factura Venta RD ON"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; 112)
        {
            ...
            column(Cabecera_NCF; wNCF)
            {
            }
            column(Cabecera_Valido; wValido)
            {
            }
            ...
            begin
                ...
                wNCF := txtNCF + "No. Comprobante Fiscal";
                //wValido := txtValido +  STRSUBSTNO('%1',"Tipo Comprobante");   //CPMCR-CEC+-
            end;
        }
    }
