report 55925 "DsPOS - NCR Venta CR FE v2"
{
    // #217374 13.09.2019  RRT   Creacion del reporte a partir de 55924
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Header"; 114)
        {
            ...
            column(Venta_Fecha; FORMAT("Posting Date"))
            {
            }
            ...
            dataitem(Pago; 55915)
            {
                DataItemLink = "No. Nota Credito" = FIELD("No.");
