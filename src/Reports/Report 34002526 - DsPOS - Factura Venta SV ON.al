report 34002526 "DsPOS - Factura Venta SV ON"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DsPOS - Factura Venta SV ON.rdlc';
        ...
        dataitem("Sales Invoice Header"; 112)
        {
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    column(CustAddr_1_; "Sales Invoice Header"."Bill-to Address")
                    {
                    }
                    column(CustAddr_2_; Cust."Search Name")
                    {
                    }
                    column(CustAddr_3_; CustAddr[3] + ' ' + CustAddr[4] + ' ' + CustAddr[5] + ' ' + CustAddr[6] + ' ' + CustAddr[7] + ' ' + CustAddr[8])
                    {
                    }
            ...
            begin
                ...
                */
                ...
                //GRN NoSerie.TESTFIELD("Invoice Copies");
                IF "Order No." = '' THEN
                    OrderNoText := ''
                ELSE
                ...
                END;
                //fes mig FormatAddr.SalesInvShipTo(ShipToAddr,"Sales Invoice Header");
