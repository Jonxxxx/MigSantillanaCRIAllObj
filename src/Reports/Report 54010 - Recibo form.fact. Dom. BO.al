...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/ReportsLayout/Recibo form.fact. Dom. BO.rdlc';
    ...
    dataset
    {
        dataitem("Historico Cab. nomina"; 34002117)
        {
            ...
            dataitem("Historico Lin. nomina"; 34002118)
            {
                ...
                column("Historico_Lin__nomina__No__empleado_"; 'Empleado: ' + "Historico Cab. nomina".Nombre)
                {
                }
                column(TODAY; TODAY)
                {
                ...
                column("Historico_Cab__nomina__Inicio"; FORMAT("Historico Cab. nomina".Inicio, 0, '<Month Text>-<Year4>'))
                {
                }
                ...
                column("Recibo_de_nomina_msg1Caption"; Recibo_de_nomina_msg1CaptionLbl)
                {
                }
                column(Agree_with_Receive2Caption; Agree_with_Receive2CaptionLbl)
                {
                }
                column("Historico_Lin__nomina_No__empleado"; "No. empleado")
                {
                }
            ...
            dataitem(HLN; 34002118)
            {
                ...
                DataItemTableView = SORTING("No. empleado", "Tipo Nomina", Periodo, "No. Orden")
                                    WHERE("Excluir de listados" = CONST(False));
                column("Historico_Lin__nomina__No__empleado2_"; 'Empleado: ' + "Historico Cab. nomina".Nombre)
                {
                }
                column(TODAY2; TODAY)
                {
                ...
                column("Historico_Cab__nomina__Inicio2"; FORMAT("Historico Cab. nomina".Inicio, 0, '<Month Text>-<Year4>'))
                {
                }
                ...
                column("Recibo_de_nomina_periodo22Caption"; Recibo_de_nomina_periodo22CaptionLbl)
                {
                }
                column("Recibo_de_nomina_periodo222Caption"; Recibo_de_nomina_periodo222CaptionLbl)
                {
                }
                ...
                column("Descripcion2Caption"; Descripcion2CaptionLbl)
                {
                }
                ...
                column("Recibo_de_nomina_msg2Caption"; Recibo_de_nomina_msg2CaptionLbl)
                {
                }
            ...
            begin
                ...
                Isr.RESET;
                Isr.SETRANGE("Cod. Empleado", "No. empleado");
    ...
    var
        ...
        "Recibo_de_nomina_periodoCaptionLbl": Label 'LIQUIDACION DE SALARIOS';
        "Recibo_de_nomina_periodo2CaptionLbl": Label 'ORIGINAL';
        ...
        "Recibo_de_nomina_msg1CaptionLbl": Label 'Percibi con total conformidad de SANTILLANA S.A.el importe detallado precedentemente, manifestando asimismo haber recibido una copia de la presente liquidacion, firmada por el Empleador.';
        Agree_with_Receive2CaptionLbl: Label 'By the company';
        TODAY2CaptionLbl: Label 'Date:';
        TIME2CaptionLbl: Label 'Time:';
        "Recibo_de_nomina_periodo22CaptionLbl": Label 'LIQUIDACION DE SALARIOS';
        "Recibo_de_nomina_periodo222CaptionLbl": Label 'COPIA';
        Descuentos2CaptionLbl: Label 'Descuentos';
        Ingresos2CaptionLbl: Label 'Ingresos';
        "Descripcion2CaptionLbl": Label 'Descripcion';
        ...
        "Recibo_de_nomina_msg2CaptionLbl": Label 'Percibi con total conformidad de SANTILLANA S.A.el importe detallado precedentemente, manifestando asimismo haber recibido una copia de la presente liquidacion, firmada por el Empleador.';
