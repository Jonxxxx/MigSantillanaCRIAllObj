tableextension 50045 EXCCRIPaymentMethod extends "Payment Method"
{
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,1 - Cash,2 - Checks/Transfers/Deposits,3 - Credit/Debit Card,4 - Credit Purchase, 5 - Exchange,6 - Credit Memo,7 - Mixed', Comment = 'ESP= ,1 - Efectivo,2 - Cheques/Transferencias/Depositos,3 - Tarjeta Crédito/Débito,4 - Compra a crédito, 5 - Permuta,6 - Nota de crédito,7 - Mixto';
