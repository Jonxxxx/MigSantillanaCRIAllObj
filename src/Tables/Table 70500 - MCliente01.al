table 55665 MCliente01
{
    ...
    fields
    {
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Apartado de correos';
        }
        field(12; "Cod.postal empresa"; Text[10])
        {
            DataClassification = CustomerContent;
            Caption = 'Cod.postal empresa';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Gabar historial de pagos';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Agrupamiento de pedidos';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Entrega completa obligatoria';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Tratam. Posterior facturas';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Class. Fiscal para el deudor';
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Codigo Cliente Santillana';
