table 34002509 "Menus TPV"
{
    ...
    begin
        ...
        CASE "Tipo Menu" OF
           "Tipo Menu"::Acciones:rConfTPV.SETRANGE("Menu de acciones","Menu ID");
           "Tipo Menu"::Pagos:rConfTPV.SETRANGE("Menu de Formas de Pago","Menu ID");
           "Tipo Menu"::Productos:rConfTPV.SETRANGE("Menu de productos","Menu ID");
        END;
        ...
        IF rConfTPV.FINDSET THEN BEGIN
          IF NOT CONFIRM(Text001,FALSE) THEN
            ERROR(Error003);
          CASE "Tipo Menu" OF
             "Tipo Menu"::Acciones:rConfTPV.MODIFYALL("Menu de acciones",'');
             "Tipo Menu"::Pagos:rConfTPV.MODIFYALL("Menu de Formas de Pago",'');
             "Tipo Menu"::Productos:rConfTPV.MODIFYALL("Menu de productos",'');
          END;
        END;
