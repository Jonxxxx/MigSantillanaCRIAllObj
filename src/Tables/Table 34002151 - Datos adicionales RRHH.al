table 34002151 "Datos adicionales RRHH"
{
    ...
    fields
    {
        field(1; "Tipo registro"; Option)
        {
            ...
            OptionMembers = Beneficio,ARS,AFP,"Tipo de Sangre","Categoría de Licencia","Categoría de Empleado",Pasatiempo,"Requisitos puestos","Tipo de préstamo","Tipo Entrenamiento","Area curricular","Salón","Categoría",Discapacidades,"Niveles-Grados","Puestos MT","Area de agrupación";
        }
