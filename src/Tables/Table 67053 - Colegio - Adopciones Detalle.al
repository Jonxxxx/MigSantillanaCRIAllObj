table 67053 "Colegio - Adopciones Detalle"
{
    ...
    fields
    {
        ...
        field(41; "Cod. Producto Editora"; Code[20])
        {
            ...
            begin
                ...
                IF LibroComp.RUNMODAL = ACTION::LookupOK THEN BEGIN
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'Fecha de entrega acordada';
        }
        field(105; "Cantidad anterior"; Decimal)
        {
            DataClassification = CustomerContent;
            Caption = 'Cantidad anterior';
            Editable = false;
        }
    }
    ...
    begin
        IF NOT UpdateActivo THEN BEGIN
            UpdateActivo := TRUE;
            ConfAPS.GET();
            AdopcionesD.RESET;
            ...
            IF AdopcionesD.FINDFIRST THEN
               ...
               BEGIN
                ...
                IF PptoPromotor.FINDFIRST THEN BEGIN
        ...
        CASE Adopcion OF
            ...
            0: //Blanco
                BEGIN
                    ...
                    IF ColAdopcion.FINDFIRST THEN BEGIN
                        ColNiv.RESET;
                        ColNiv.SETRANGE("Cod. Colegio", "Cod. Colegio");
                        ColNiv.SETRANGE(Turno, "Cod. Turno");
                        ColNiv.SETRANGE(Ruta, PromRuta."Cod. Ruta");
