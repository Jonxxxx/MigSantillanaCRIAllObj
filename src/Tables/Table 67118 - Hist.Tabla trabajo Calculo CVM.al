table 67118 "Hist.Tabla trabajo Calculo CVM"
{
    ...
    keys
    {
        key(Key1;"Campa a","Cod. Colegio")
        {
        }
        key(Key2;"Campa a","Delegaci n","MONTO POTENCIAL_GENERAL")
        {
        }
        key(Key3;"Campa a","Delegaci n","No. Orden")
        {
        }
        key(Key4;"Campa a","Delegaci n","MONTO TOTAL_GENERAL")
        {
        }
        key(Key5;"Campa a","Delegaci n","No. Orden Ranking General")
        {
        }
        key(Key6;"Campa a","Delegaci n","CVM CAMPA A")
        {
        }
        key(Key7;"Campa a","Delegaci n","No. Orden Ranking CVM")
        {
        }
    }
