    ...
    begin
        ...
        IF lrContrato.FINDFIRST THEN
            REPEAT
                ...
                //... 3. Permitiremos que la fecha final esté sin valor, solo si y solo, se trata del último contrato ligado al empleado.
                IF pRevisarContratoIndefinidoQueSeaUltimo THEN BEGIN
                    IF lrContrato."Fecha finalizacion" = 0D THEN BEGIN
