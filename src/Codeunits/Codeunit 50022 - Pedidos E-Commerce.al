codeunit 50022 "Pedidos E-Commerce"
{
    ...
    // 006         YFC      21/03/2022       SANTINAV-3030 Error cola facturación electronica
    // 007         SSM      21-Sep-2022      SANTINAV-3721 - Colocar categoria de pedidos
    // 008         LDP      10-02-2023       SANTINAV-4272 Orden de tienda línea sin sincronizar
                        ...
                        BEGIN
                            ...
                            IF NOT ValidarError THEN   // ++ 004-YFC
                             BEGIN // 004-YFC
                                ...
                                IF (CabVtaSFA."Cód. Dirección de envío" <> '') AND (CabVtaSFA."Cód. Dirección de envío" <> ConfSantillana."Cliente Contado E-Commerce") THEN
                                    CabVentaOut.VALIDATE("Ship-to Code", CabVtaSFA."Cód. Dirección de envío");
