codeunit 50116 "Registrar Cobros DsPos"
{
    ...
    // 002       29-07-2024       LDP      SANTINAV-6732:Facturacion Electronica DSPOS para migracion a BC
    ...
    var
        Msg001: Label 'Liq. pago Doc. %1';
        Error001: Label 'No existen lineas de pagos sic pendientes a liquidar para la factura %1';
        Error002: Label 'No existen lineas Medios de Pagos en tabla "Medios de Pagos SIC"';
    begin
    ...
    var
        Msg001: Label 'Liq. pago Doc. %1';
        Error001: Label 'No existen lineas de pagos sic pendientes a liquidar para nota credito %1';
    begin
        ConfigEmpresa.GET;
