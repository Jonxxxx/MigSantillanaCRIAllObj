codeunit 55469 "Funciones Calculo Ranking"
{
        ...
        CASE gTipo OF
            gTipo::CVM:
                BEGIN
                    ...
                    tTrabajo.SETRANGE(tTrabajo.Campana, gCamp);
                    IF gDeleg <> '' THEN
                        tTrabajo.SETRANGE(tTrabajo.Delegacion, gDeleg);
                    tTrabajo.DELETEALL;
    ...
    begin
        ...
        ELSE BEGIN
            ...
            recHistCategoria.SETRANGE(Campana, gCamp);
    ...
    begin
        ...
        tTrabajo.Delegacion := recColegio.Delegacion;
        //tTrabajo."Cod. Zona"  :=
    ...
    begin
        ...
        CASE gTipo OF
            gTipo::General:
                BEGIN
                    tTrabajo.SETCURRENTKEY(Reporte, Campana, Delegacion, "MONTO TOTAL_GENERAL");
                    tTrabajo.ASCENDING(FALSE)
                END;
            gTipo::CVM:
                tTrabajo.SETCURRENTKEY(Reporte, Campana, Delegacion, tTrabajo."CVM GN");
        END;
