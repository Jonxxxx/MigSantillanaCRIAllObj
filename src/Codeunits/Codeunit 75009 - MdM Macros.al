codeunit 75009 "MdM Macros"
{
    ...
    var
        ...
        i: Integer;
        excelbuff2Record 370" temporary;
    ...
    begin
        ...
        CLEAR(lrRefC);
        lrRefC.SETRANGE("Cross-Reference Type", lrRefC."Cross-Reference Type"::"Bar Code");
    ...
    begin
        ...
        IF i <> 0 THEN BEGIN
            ...
            */
            ...
            preciosVenta.SETRANGE("Starting Date", 090919D);
            IF preciosVenta.FINDFIRST THEN
                IF (preciosVenta."Ending Date" = 0D) OR (preciosVenta."Ending Date" > 103019D) THEN BEGIN
                    preciosVenta."Ending Date" := 103119D;
                    preciosVenta.MODIFY;
                END;
        END;
        //-#278368
