codeunit 56202 "MdE Management"
{
    ...
    // MdM JPT 25/09/17 Añadonueva funcion SendPostRequest2
    ...
    begin
        ...
        IF ConfSant."MdE Activo" THEN BEGIN
            ...
            IF Rec."Cod. contrato" <> xRec."Cod. contrato" THEN
                ERROR(ErrorModify, Rec.FIELDCAPTION("Cod. contrato"), Rec.TABLECAPTION);
            ...
            IF Rec."Fecha finalizacion" <> xRec."Fecha finalizacion" THEN
                ERROR(ErrorModify, Rec.FIELDCAPTION("Fecha finalizacion"), Rec.TABLECAPTION);
