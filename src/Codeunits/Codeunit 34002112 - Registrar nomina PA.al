codeunit 34002112 "Registrar nomina PA"
{
    TableNo = 34002115;
    ...
    begin
        ...
        ELSE BEGIN
            ...
            LinAportesEmpresa.SETRANGE(Periodo, DMY2DATE(1, DATE2DMY(PerInici, 2), DATE2DMY(PerInici, 3)), PerFinal);
    ...
    var
        ...
        DiasVac: Integer;
    begin
        // 30 dias a partir de los 11 meses
        FuncNomina.CalculoEntreFechas(Empleado."Employment Date", PerFinal, AnoCalculado, MesCalculado, DiaCalculado);
