codeunit 56050 "Clasificacion devoluciones"
{
    ...
    var
        ...
        Text006: Label '################################1\\';
        Text007: Label 'Clas. devolucion      ##########2\';
    ...
    begin
        ...
        IF recTmpProd.FINDSET THEN
            REPEAT
                ...
                //Si hay inventario enconsignacion se generaran devoluciones de transferencias.
    ...
    begin
        ...
        //Los productos, para los que no se ha generado transferencia devolucion consignacion, se inluirán en devoluciones de venta.

        //Los productos, sin defectos, se incluirán en devoluciones que liquidarán facturas de venta
        //Los productos defectuosos se inluirán en una devolucion sin liquidar factura de venta
        //Y los productos, sin defectos, que no se pueden liquidar con facturas de venta se incluirán en una devolucion sin liquidar factura


        //Devolucion de productos sin defectos liquidables :
        ...
        //Devolucion de productos defectuosos liquidables :
        ...
        //Devolucion del resto de productos sin defectos que no se pueden liquidar :
        ...
        //Devolucion del resto de productos defectuosos que no se pueden liquidar :
        codCabVta := '';
        recTmpProd.RESET;
        recTmpProd.SETFILTER("Cantidad defectuosa", '<>%1', 0);
        IF recTmpProd.FINDFIRST THEN BEGIN
    ...
    begin
        ...
        IF blmPrmLiquidarCdad THEN BEGIN
            ...
            END
            ELSE   //Si la factura que devolvemos NO esta pendiente se liquidan importes según configuracion.
                LiquidarImportes(recCabVta);
        END
        ELSE
            LiquidarImportes(recCabVta); //Aunque no liquidemos cantidades se debe liquidar los importes según configuracion
        ...
        IF recTmpProd.FINDSET THEN
            REPEAT
                ...
                IF (decCdadADev <> 0) THEN BEGIN
                        ...
                        REPEAT
                            ...
                            IF recLinFac.FINDSET THEN
                                REPEAT
                                    ...
                                    //$001  Se guarda el el mov. producto para liquidar en la devolucion
                                    recMovValor.RESET;
                    ...
                    //Si quedan productos sin liquidar se guardan para generar una devolucion sin fact. a liq.
                    IF decCdadADev <> 0 THEN BEGIN
                        recTmpFactProd.INIT;
