codeunit 50112 "Registra Pedidos Vta. SIC_BC"
{
    ...
    // 002        26/02/2024      LDP      SANTINAV-5844 Problemas en la replicacion Equipo Canal 3
    ...
    begin
        ...
        //SH.SETCURRENTKEY("Actualizado WMS");
        SH.SETRANGE("Venta TPV", TRUE);
        SH.SETRANGE("Posting Date", 20220531D, 20230101D);//AMS Temporal
        propina := 0;
    ...
    var
        ...
        Error004: Label 'Imp. cab. SIC no coincide con imp. lineas';
    ...
    begin
        ...
        IF SH.FINDSET() THEN
            REPEAT
                ...
                /*
                ParametrosLocxPais.RESET;
                ParametrosLocxPais.SETRANGE("Pais",'GT');
                IF CantidadLin >  ParametrosLocxPais."Cantidad Lin. por factura" THEN BEGIN
                */

                //LDP+ No cuentan con esta configuracion activa, se comenta //15/01/2024
                /*
                IF CantidadLin > ConfigEmpresa."Cantidad Lin. por factura" THEN BEGIN
                  ...
                  SH.MODIFY;
                END;
                *///LDP+ No cuentan con esta configuracion activa //15/01/2024
