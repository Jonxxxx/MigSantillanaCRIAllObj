codeunit 67001 "Generacion Words APS"
{
    ...
    var
        ...
        intFila: Integer;
        i: Integer;
        Error001: Label 'Debe cargar una plantilla Word (.dot) para la generacion de la Solicitud de Asistencia Ténica pedagogica.';
        Error002: Label 'Debe indicar la ruta donde guardar la Solicitud de Asistencia Ténica pedagogica.';
          ...
          FOR i := 1 TO wdApp.ActiveDocument.Fields.Count DO BEGIN
            ...
            IF wdField.Type = 59 THEN BEGIN                                          //Solo campos tipo MailMerge
              ...
              CASE texNombreCampo OF
                ...
                'EventoProg'            : wdRange.Text := "Cod. evento programado" + ' - ' + "Descripcion evento programado";
                ...
                'MatRev'                : wdRange.Text := FORMAT(recSolicitud."Material para revision");
              END;
            END;
          END;
        END;
    ...
    begin
        //CPMCR-CEC+
        /*
        //Genera Tabla con la programacion
        intFila := 1;
    ...
    var
        ...
        intFila: Integer;
        i: Integer;
        Error001: Label 'Debe cargar una plantilla Word (.dot) para la generacion de la la ficha de PP.FF.';
          ...
          FOR i := 1 TO wdApp.ActiveDocument.Fields.Count DO BEGIN
            ...
            IF wdField.Type = 59 THEN BEGIN                                          //Solo campos tipo MailMerge
              ...
              CASE texNombreCampo OF
                ...
                'Cargo'                 : BEGIN wdRange.Text := "Descripcion Cargo Responsable";  END;
    ...
    begin
        ...
        IF lineas > 0 THEN BEGIN
          ...
          IF recNivel.FINDSET THEN
           REPEAT
             intFila += 1;
             wdTable.Cell(intFila,1).Range.InsertAfter(recNivel.Descripcion);
          ...
          IF recGrado.FINDSET THEN
           REPEAT
             intFila += 1;
             wdTable.Cell(intFila,2).Range.InsertAfter(recGrado.Descripcion);
          ...
          IF recEspec.FINDSET THEN
           REPEAT
             intFila += 1;
             wdTable.Cell(intFila,3).Range.InsertAfter(recEspec.Descripcion);
    ...
    begin
        ...
        IF recCompetencia.FINDSET THEN BEGIN
          ...
          REPEAT
            ...
            wdTable.Cell(intFila,4).Range.InsertAfter(recCompetencia."Año Adopcion");
            FOR nCol := 1 TO 5 DO BEGIN
              wdTable.Cell(intFila,nCol).Range.Font.Size := 8;
              wdTable.Cell(intFila,nCol).Range.Borders.Item(2).LineStyle :=  1;
              wdTable.Cell(intFila,nCol).Range.Borders.Item(4).LineStyle :=  1;
    ...
    var
        ...
        intFila: Integer;
        i: Integer;
        Error001: Label 'Debe cargar una plantilla Word (.dot) para la generacion de las Visitas';
    ...
    begin
        ...
        IF parDelegacion <> '' THEN
          Prog.SETRANGE(Delegacion,parDelegacion);
        ...
        IF Prog.FINDSET THEN BEGIN
          REPEAT
             IF (wAntVisita  <> Prog."No. Visita") OR (wAntFecha <> Prog."Fecha Programada") THEN BEGIN
               ...
               InsertCell(wdTable,intFila + 16,ncol,'Tipo de accion: ' + GetTipoEvento(Prog) + '   Equivalencia:  __________',0,10,FALSE);
