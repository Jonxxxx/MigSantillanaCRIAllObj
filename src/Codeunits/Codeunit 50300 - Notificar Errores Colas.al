codeunit 50300 "Notificar Errores Colas"
{
    ...
    begin
        ...
        SMTPMail.CreateMessage(CompanyInfo.Name, ConfEmpresa."Email Envia Errores Colas", SendToAddress, Subject, MessageBody, FALSE);
        //002-

        SendOK := SMTPMail.TrySendCR(ConfEmpresa."Email Envia Errores Colas", ConfEmpresa."Password Email Errores Colas");
