codeunit 75000 "Funciones MdM"
{
    ...
    var
        ...
        ErrEditDim2: Label 'No puede editar esta dimension, se gestiona por MdM.';
    ...
    begin
        // GetDimCode
        // Devuelve el Codigo de una dimension determinada
    ...
    begin
        // GetDimCodeName
        // Devuelve el nombre de un codigo de dimension
    ...
    begin
        // GetDimValueName
        // Devuelve el nombre de un valor de dimension
    ...
    begin
        // TestDimValC
        // Comprueba que exista el valor de dimension
    ...
    begin
        // ExistDimValC
        // Devuelve true si existe el valor de dimension
    ...
    begin
        // ExecDimValLookupT
        // Solicita un codigo de valor de dimension y lo valida. (Por Tipo)
    ...
    begin
        // ExecDimValLookupC
        // Solicita un codigo de valor de dimension y lo valida (Por Codigo)
    ...
    begin
        // ShowDimT
        // Muestra la dimension establecida
    ...
    begin
        // SetTipoDim
        // Define el valor "Tipo MdM" de la tabla de Dimensiones en virtud del valor de configuracion
    ...
    begin
        ...
        CASE pwId OF
            1:
                wIdField := 5704; // Cod. Grupo Producto
        END;
    end;
    ...
    begin
        // GetIdiomaDesc
        // Devuelve la descripcion del idioma
    ...
    begin
        // GetDimEditable
        // Determina si la dimension es editable
    ...
    begin
        // GetDimValueEditable
        // Determina un valor de dimension es editable
    ...
    begin
        // ControlIBN
        // Devuelve true si el digito de control es correcto
        ...
        lwTotal := 0;
        wOK := EVALUATE(lwCont, FORMAT(pwCode[13])); // Digito de control
        IF wOK THEN BEGIN
    ...
    var
        lrDefDim: Record 352;
        lrDefDim2: Record 352;
        lrDefDim3: Record 352;
    begin
        // GetDefDimesions
    ...
    begin
        ...
        // El campo Inactivo de Navision se marque cuando un articulo adquiera en el MdM el estado Y8 FONDO DE BAJA
        // JPT 08/01/2019
