pageextension 50113 EXCCRIItemCategoryCard extends "Item Category Card"
{
    layout
    {
        addafter("Parent Category")
        {
            ...
            field(EXCCRIDefTaxGroupCode; Rec."Def. Tax Group Code")
            {
                ApplicationArea = All;
                ToolTip = 'Specifies the default tax group code for items in the category.';
            }
